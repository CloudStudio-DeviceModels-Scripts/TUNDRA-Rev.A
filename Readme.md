...
# Parsing Script – TUNDRA - Rev. A

This **Parsing** script is designed for the **TUNDRA** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – TUNDRA Rev. A

Este script de **Parsing** está diseñado para el modelo **TUNDRA** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
